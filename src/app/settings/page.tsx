    ...
    <div className="p-6 max-w-4xl mx-auto">
      <div className="flex items-center gap-3 mb-6">
        ...
        <div>
          ...
          <p className="text-gray-500">Configure notifications and integrations</p>
        </div>
      </div>
      ...
      <div className="space-y-6">
        ...
        <div className="bg-white rounded-xl border border-gray-200 p-6">
          <div className="flex items-center gap-3 mb-6">
            ...
            <h3 className="text-lg font-semibold text-gray-900">Reminder Notifications</h3>
          </div>
        ...
        <div className="bg-gradient-to-r from-blue-50 to-indigo-50 rounded-xl border border-blue-100 p-6">
          <h3 className="text-lg font-semibold text-gray-900 mb-4">Setting Up Integrations</h3>
            ...
            <div className="flex gap-3">
              ...
              <div>
                ...
                <p className="text-sm text-gray-600">
                  ...
                  3. Get your chat ID by visiting: <code className="bg-white px-1 py-0.5 rounded text-xs">https://api.telegram.org/bot[TOKEN]/getUpdates</code>
                </p>
              </div>
            </div>
