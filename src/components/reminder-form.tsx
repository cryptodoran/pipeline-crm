      ...
      <div className="relative bg-gray-800 rounded-xl shadow-xl w-full max-w-md mx-4">
        <div className="flex items-center justify-between p-4 border-b border-gray-700">
          <div className="flex items-center gap-2">
            ...
            <h3 className="font-semibold text-white">Set Reminder</h3>
          </div>
        ...
        <form onSubmit={handleSubmit} className="p-4 space-y-4">
          <p className="text-sm text-gray-300">
            Remind me about <span className="font-medium text-white">{leadName}</span>
          </p>
          ...
          <div className="grid grid-cols-2 gap-3">
            <div>
              ...
              <input
                ...
                required
                className="w-full rounded-lg border border-gray-600 bg-gray-700 text-white px-3 py-2 text-sm focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
              />
            </div>
            <div>
              <label className="block text-sm font-medium text-gray-300 mb-1">
          ...
          <div>
            ...
            <textarea
              ...
              rows={2}
              className="w-full rounded-lg border border-gray-600 bg-gray-700 text-white placeholder-gray-400 px-3 py-2 text-sm focus:ring-2 focus:ring-blue-500 focus:border-blue-500 resize-none"
            />
          </div>
