        ...
        <div className="flex items-center justify-between mb-4">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-sm text-gray-500">Receive reminders via Telegram bot</p>
            </div>
          </div>
          <button
        ...
        <div className="flex items-center justify-between mb-4">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-sm text-gray-500">Receive reminders in a Slack channel</p>
            </div>
          </div>
          <button
            ...
            <div>
              ...
              <div className="flex gap-2">
                ...
                <button
                  ...
                  disabled={!settings.slackWebhookUrl || testingChannel === 'slack'}
                  className="px-3 py-2 bg-gray-100 text-gray-700 rounded-lg hover:bg-gray-200 disabled:opacity-50 flex items-center gap-1"
                >
